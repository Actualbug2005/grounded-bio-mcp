...
:class:`~grounded_bio_mcp.utils.rate_limit.RateLimitedClient` and use
...
class NCBIClient:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        self._client = RateLimitedClient(
            ...
            timeout=30.0,
            headers={"User-Agent": "grounded-bio-mcp/0.2 (+ncbi-client)"},
        )
        ...
        self._blast_client = RateLimitedClient(
            ...
            timeout=60.0,
            headers={"User-Agent": "grounded-bio-mcp/0.2 (+ncbi-blast)"},
        )
